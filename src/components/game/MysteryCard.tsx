      ...
      >
        ...
        <div
          className="absolute inset-0 rounded-2xl bg-gradient-to-br from-violet-600 to-fuchsia-600
            flex flex-col items-center justify-center shadow-2xl shadow-violet-600/30 border border-white/20"
        ...
        <div
          className="absolute inset-0 rounded-2xl bg-gradient-to-br from-violet-900 to-fuchsia-900
            flex flex-col items-center justify-center shadow-2xl border border-white/20 p-4 text-center"
          style={{
        ...
        >
          {song && (
            <>
              ...
              <p className="text-violet-300 font-bold text-2xl mt-2">
                {song.year}
              </p>
            </>
          )}
